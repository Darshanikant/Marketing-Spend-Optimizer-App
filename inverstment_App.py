...
# Input fields
digital_marketing = st.number_input("Digital Marketing", min_value=0.0, max_value=10000000.0, value=0.0, step=1.0)
promotion = st.number_input("Promotion", min_value=0.0, max_value=10000000.0, value=0.0, step=1.0)
research = st.number_input("Research", min_value=0.0, max_value=10000000.0, value=0.0, step=1.0)
